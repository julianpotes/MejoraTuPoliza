  ...
  <footer class="page-footer text-center text-md-left blue-grey lighten-5 pt-0">
      ...
      <div class="container">
        ...
        <div class="row py-4 d-flex align-items-center">
          ...
          <div class="col-12 col-md-5 text-left mb-md-0">
            <h6 class="mb-0 white-text text-center text-md-left"><strong>Conéctate con nosotros en las redes redes socialesredes!</strong></h6>
          </div>
          <!--Grid column-->
    ...
    <div class="container mt-5 mb-4 text-center text-md-left">
      <div class="row mt-3">
        ...
        <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4 dark-grey-text">
          <h6 class="text-uppercase font-weight-bold"><strong>Todos Los Productos</strong></h6>
          <hr class="blue mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;">
          <p><a href="#!" class="dark-grey-text">Motos</a></p>
          <p><a href="#!" class="dark-grey-text">Autos</a></p>
          <p><a href="#!" class="dark-grey-text">Casas</a></p>
          <p><a href="#!" class="dark-grey-text">Mascotas</a></p>
        </div>
        <!--/.Second column-->

        <!--Third column-->
        <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4 dark-grey-text">
          <h6 class="text-uppercase font-weight-bold"><strong>Polizas</strong></h6>
          <hr class="blue mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;">
          <p><a href="#!" class="dark-grey-text">Preguntas</a></p>
          <p><a href="#!" class="dark-grey-text">Como Apiliarme</a></p>
          <p><a href="#!" class="dark-grey-text">Shipping Rates</a></p>
          <p><a href="#!" class="dark-grey-text">Ayuda</a></p>
        </div>
        <!--/.Third column-->Otros seguros

        <!--Fourth column-->
        <div class="col-md-4 col-lg-3 col-xl-3 dark-grey-text">
          <h6 class="text-uppercase font-weight-bold"><strong>Contacto</strong></h6>
          <hr class="blue mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;">
          <p><i class="fas fa-home mr-3"></i> La Plata, Bs Ars, Argentna</p>
          <p><i class="fas fa-envelope mr-3"></i> info@example.com</p>
          <p><i class="fas fa-phone mr-3"></i> + 54 9 221 111111</p>
          <p><i class="fas fa-print mr-3"></i> + 54 9 221 111111</p>
        </div>
        <!--/.Fourth column-->
    ...
    <div class="footer-copyright py-3 text-center">
      <div class="container-fluid">
        © 2019 Copyright: <a href="mejoratupoliza.com.ar" target="_blank"> Mejora Tu Poliza</a>
      </div>
    </div>
    <!--/.Copyright -->
